    ...
    <div className={`sm-scope ${isFixed ? 'sm-scope--fixed' : 'sm-scope--relative'}`}>
      ...
      >
        ...
        <div ref={preLayersRef} className="sm-prelayers" aria-hidden="true">
          {(() => {
            const raw = colors && colors.length ? colors.slice(0, 4) : ['#35b04b', '#2d9340'];
            let arr = [...raw];
            if (arr.length >= 3) {
        ...
        <header className="staggered-menu-header" aria-label="Main navigation header">
          <div className="sm-header-inner">
            <div className="sm-logo" aria-label="Logo">
              <span className="sm-logo-text">Masum&apos;s</span>
      ...
      <style>{`
/* ============================================================
   STAGGERED MENU — Masum Portfolio Theme
   Font: Montserrat | Accent: #35b04b | bg: #fff
   ============================================================ */
...
.sm-scope .sm-socials-link::after {
  ...
  bottom: 0; left: 0;
  width: 0; height: 2px;
  background: var(--sm-accent, #35b04b);
  border-radius: 2px;
...
.sm-scope .sm-socials-link:focus-visible {
  outline: 2px solid var(--sm-accent, #35b04b);
  outline-offset: 3px;
}
